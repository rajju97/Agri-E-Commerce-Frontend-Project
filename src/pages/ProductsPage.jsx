...
const ProductsPage = () => {
    ...
    // ⚡ Bolt: Memoized derived state to prevent expensive O(n log n) sorting and O(n) filtering on every render.
    // Also extracted string conversions (toLowerCase) outside the filter loop to save redundant allocations.
