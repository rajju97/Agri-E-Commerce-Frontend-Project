...
const ProductsPage = () => {
    ...
    // ⚡ Bolt Performance Optimization: Memoize filtered products
    // Prevents expensive O(n log n) filter and sort operations from running
    // on every render (e.g., when search input changes keystroke by keystroke)
